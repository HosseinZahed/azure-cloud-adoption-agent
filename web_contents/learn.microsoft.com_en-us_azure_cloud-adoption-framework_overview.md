...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Strategy icon](_images/icons/strategy.png) | [Strategy](strategy/) : Define business justification and expected adoption outcomes. | ![Plan icon](_images/icons/plan.png) | [Plan](plan/) : Align actionable adoption plans to business outcomes. |
| ![Ready icon](_images/icons/ready.png) | [Ready](ready/) : Prepare your cloud environment for planned changes. | ![Migrate icon](_images/icons/adopt.png) | [Migrate](migrate/) : Migrate and modernize existing workloads. |
| ![Innovate icon](_images/icons/innovate.png) | [Innovate](innovate/) : Develop new cloud-native or hybrid solutions. | ![Secure icon](_images/icons/security.png) | [Secure](secure/overview) : Improve security over time. |
| ![Manage icon](_images/icons/manage.png) | [Manage](manage/) : Manage operations for cloud and hybrid solutions. | ![Govern icon](_images/icons/govern.png) | [Govern](govern/) : Govern your environment and workloads. |
| ![Organize icon](_images/icons/organize.png) | [Organize](organize/) : Align the teams and roles supporting your organization's cloud adoption efforts. |  |  |
...
![Diagram showing an overview of Microsoft's Cloud Adoption Framework.](_images/caf-overview-graphic.png)
...
If your organization is new to Azure, begin by ensuring you
[understand and document foundational alignment decisions](get-started/cloud-concepts)
. When your enterprise's digital transformation involves the cloud, having an understanding of these fundamental concepts helps you during the cloud adoption process.
